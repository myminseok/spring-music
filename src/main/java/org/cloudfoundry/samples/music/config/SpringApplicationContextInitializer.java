...
public class SpringApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private static final List<String> validLocalProfiles = Arrays.asList("mysql", "postgres", "mongodb", "redis", "mysql-local");
    ...
    static {
        ...
        serviceTypeToProfileName.put(SqlServerServiceInfo.class, "mysql-local");
    }
